...
const ExperienceForm = ({data,onChange }) => {
  ...
  return (
    ...
    <div className='flex items-center justify-between'> 
       ...
       <h3 className='flex items-center gap-2 text-center text-lg font-semibold text-gray-900'>Professional Experience </h3>
           ...
           <div className='grid md:grid-cols-2 gap-3'>
            ...
            className="px-3 py-2 text-sm rounded-lg disabled:bg-gray-100" />
              ...
              <label className='flex items-center gap-2'>
                <input type="checkbox" checked={experience.is_current || false} onChange={(e)=>{updateExperience(index,"is_current" , e.target.checked ? true :false); }} className='rounded border-gray-300 text-blue-600 focus-within:ring-blue-500'/>
